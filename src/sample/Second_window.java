...
public class Second_window implements Initializable {
    ...
    public void afficherConso() {
        ...
        co2.setTooltip(new Tooltip("L’estimation du rejet de CO2 évité est aussi à prendre en compte. Selon l’ADEME (Agence de l’environnement et de la maîtrise) en 2015 \n"+" un panneau photovoltaïque rejette en moyenne 55 grammes de CO2eq par kWh dans son cycle de vie contre 82 grammes de CO2eq par kWh pour le réseau électrique classique français. \n"+" Une estimation de quantité de CO2eq par kWh est donc possible en ayant " +
                "la production en kWh des panneaux photovoltaïques de l’installation"));
        emissionCO2.setTooltip(new Tooltip("L’estimation du rejet de CO2 évité est aussi à prendre en compte. Selon l’ADEME (Agence de l’environnement et de la maîtrise) en 2015 \n"+" un panneau photovoltaïque rejette en moyenne 55 grammes de CO2eq par kWh dans son cycle de vie contre 82 grammes de CO2eq par kWh pour le réseau électrique classique français. \n"+" Une estimation de quantité de CO2eq par kWh est donc possible " +
